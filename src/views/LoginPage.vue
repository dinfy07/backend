...
function logIn() {
  login(tel.value, password.value)
  tel.value = "";
  password.value = "";
}
</script>
...
<template>
  <main>
    ...
    <div class="input">
      ...
      <input v-model="tel" type="text" placeholder="+7 (999) 123-45-67">
    </div>
    <div class="input">
      <h6>Пароль</h6>
    ...
    <router-link :to="{name: 'application'}" ><h5>Оставить заявку</h5></router-link>
  </main>
</template>
